...
def test_raw_data(mock_get):
    ...
    data = [
        {'address': {'building': '9с10',
                     'city': 'Москва',
                     'description': 'На проходной потребуется паспорт',
                     'lat': 55.807794,
                     'lng': 37.638699,
                     'metro_stations': [{'lat': 55.807794,
                                         'line_id': '6',
                                         'line_name': 'Калужско-Рижская',
                                         'lng': 37.638699,
                                         'station_id': '6.8',
         ...
         'brand_snippet': {'background': {'color': None,
                                          'gradient': {'angle': 45,
                                                       'color_list': [
                                                           {'color': '#FF0000',
                                                            'position': 10},
                                                           {'color': '#FA0000',
                                                            'position': 9}]}},
                           'logo': 'https://hhcdn.ru/00001.png',
                           'logo_scalable': {'default': {'height': 300,
                                                         'url': 'https://hhcdn.ru/00021.png',
                                                         'width': 500},
                                             'xs': {'height': 100,
                                                    'url': 'https://hhcdn.ru/00022.png',
                           ...
                           'logo_xs': 'https://hhcdn.ru/00002.png',
                           'picture': 'https://hhcdn.ru/00003.png',
                           'picture_scalable': {'default': {'height': 350,
                                                            'url': 'https://hhcdn.ru/00023.png',
                                                            'width': 550},
                                                'xs': {'height': 150,
                                                       'url': 'https://hhcdn.ru/00024.png',
         ...
         'department': {'id': 'HH-1455-TECH',
                        'name': 'HeadHunter::Технический департамент'},
         'employer': {'accredited_it_employer': False,
                      'alternate_url': 'https://hh.ru/employer/1455',
                      'id': '1455',
                      'logo_urls': {'240': 'https://hh.ru/employer-logo/289169.png',
                                    '90': 'https://hh.ru/employer-logo/289027.png',
                                    'original': 'https://hh.ru/file/2352807.png'},
                      'name': 'HeadHunter',
                      'trusted': True,
         ...
         'show_logo_in_search': True,
         'snippet': {'requirement': 'Высшее образование. Опыт работы в качестве '
